...
public class RedNearAutoTimeBased extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        driveWhileSpinUp(4, 0, 0, 0, 0, 0.68, -0.8,1,0.9,0);
        driveWhileSpinUp(2, 0, 0, 0, 0, 0.68, -0.8,0.85,0.7,0);
        driveWhileSpinUp(0.22, 0.5, -0.5, 0.5, -0.5, 0, 0,1,0.9,0); //turns after shooting three balls
        driveWhileSpinUp(0.71, 0.5, -0.5, -0.5, 0.5, 0, 0,1,0.9,0);//straifs to other 3 balls
